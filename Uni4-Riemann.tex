...
\begin{definicion}{}[Uniforme continuidad] \index{continuidad!uniforme} Sean $(X,d)$ e $(Y,d')$ espacios métricos. Diremos que $f:X\to Y$ es uniformemente continua si 
\[
...
\end{cases}
\]
\marginpar{\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{imagenes/dirichlet.png}\\
...
\begin{ejemplo}{} Discutir los ejemplos Thomae, Dirichlet, Heaveside, Continuas, escalera discontinua.  
