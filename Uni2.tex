...
\begin{quotation}
\marginnote{\includegraphics[scale=.6]{imagenes/Riemann.jpeg}\\
...
\marginnote{\includegraphics[scale=.8]{imagenes/Darboux.jpg}\\
...
\marginnote{\includegraphics[scale=.25]{imagenes/dirichlet.png}\\
...
\]
\end{ejemplo}
\marginnote{\includegraphics[scale=.15]{imagenes/thomae.png}\\
Función de Thomae}
...
\marginnote{\includegraphics[scale=.22]{imagenes/escalera.png}\\
...
\marginnote{\includegraphics[scale=.24]{imagenes/serrucho.pdf}\\
Función serrucho}
\begin{sympyverbatim}
x=symbols('x')
g=x-floor(x+.5)
...
plot(f,(x,0,1))
\end{sympyverbatim}
\marginnote{\includegraphics[scale=.3]{imagenes/funcRiemann.png}\\
Función de Riemann}
