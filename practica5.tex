...
\begin{color}{red}
\begin{ejer}[Criterio de Lebesgue para la integrabilidad Riemann]{} El criterio establece que si $f:[a,b]\to\rr$ es acotada entonces  son equivalentes
\begin{enumerate}
...
Para b)$\Rightarrow$ a). Notar que $m_*(S_n)=0$. Luego, para todo $\varepsilon>0$ se puede hallar una colección de intervalos abiertos y disjuntos $I_j$ tales que $S_n\subset \bigcup_{j=1}^\infty I_j$ y   $\sum_jm(I_j)<\varepsilon$.  Demostrar que $S_n$ es compacto y de allí se cubre por finitos $I_j$. Finalemnte invocar la caracterización de Haenkel.
\end{ejer}
\end{color}
...
\begin{ejer}{}
  Mostrar que la función $x^{p-1} e^{-x}$ es integrable sobre $(0,\infty)$ si y sólo si $p>0$. \textcolor{red}{Quizás es más importante que aprenda cuando las funciones $1/x^p$ son integrales en $(0,1)$ y $(1,\infty)$. ¿no?}
	\end{ejer}
...
\end{ejer}
	...
	\begin{ejer}{} \textcolor{red}{Este resultado no estaría contemplado con el ejercicio 9a?}
  ...
  \end{ejer}
	...
	Probar que $f$ es integrable de Lebesgue en $\rr$ \textcolor{red}{¿Capaz que sea en $[0,+\infty)$, no?}.
  ...
  \begin{ejer}{} \textcolor{red}{Yo creo Sonia que esto estaría bueno dejarlo para los $L^p$}
  ...
  que $a<b$, ?`puede concluirse que $f(x)>0$ en c.t.p $x$?
	...
	\begin{ejer}{}\textcolor{red}{Capaz lo trabaje en el teórico}
...
\begin{ejer}{} \textcolor{red}{Como vamos a adoptar el enfoque de Fava y Zó no sería adecuado este ejercicio}
...
\textcolor{red}{Los siguientes ejericios me gustan todos, pero ¿No quedará demasiado larga la práctica?. ¿NO te parece que asterisquemos 23,25,26,27?}
