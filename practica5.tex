...
donde $\alpha_n\geq 0$. 
 ...
 \textbf{OJO! LA SEGUNDA INTEGRAL NO SALE TAN FÁCIL POR DEFINICIÓN! }
...
%e un intervalo  infinito (tal integral
 ...
 % \end{ejer}
  ...
  \end{ejer}
	...
	%\textcolor{red}{¿Capaz que sea en $[0,+\infty)$, no?}.
...
%	Probar que para cada $\epsilon>0$ existe %$\delta>0$ tal que $\int_E |f|\,dx<\epsilon$ siempre %que $m(E)<\delta$.
  ...
  $a<t<b$, dependiente de un parámetro real $t$, de la manera siguiente:
   ...
   $$\int_E f(x)\,dx=\lim_{t \rightarrow \tau}\int_E f_t(x)\,dx. $$
	...
	\begin{ejer} [Derivación de una integral paramétrica]{}*
...
\begin{ejer}[Transformada de Fourier]{}*
