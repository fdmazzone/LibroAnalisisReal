...
%CAPITULO I
%=======================================================================
\chapter{Conjuntos}\label{cap:cardinalidad}
\marginpar{
\begin{center}
...
de una matríz infinita como se muestra en la figura \ref{fig:NxN}.
\begin{figure}

  \begin{center}
 \includegraphics[scale=.3]{imagenes/NxN-numerable.png}
 % NxN-numerable.png: 749x599 px, 72dpi, 26.42x21.13 cm, bb=0 0 749 599
\end{center}
  \caption{Demostración de que $\mathbb{N}\times \mathbb{N}$ es numerable}\label{fig:NxN}
\end{figure}
